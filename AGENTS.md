...
Every prompt has one source of truth plus generated artifacts that must stay in sync:
...
Manual edits to generated prompt docs/runtime files cause drift and will fail pre-commit and CI. Do not skip steps.
