...
Welcome to **AgentVisualCrazy**. This guide will help you get the project running locally for development and testing.

## Setup

Use Node 20+ and run commands from the repository root.
...
All tests on `main` should pass. If you
...
hook in `.githooks/pre-push` that runs `npm test` and `npm run test:live`
